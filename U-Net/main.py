...
parser = argparse.ArgumentParser(description='U-Net, for noise/artifact removal in CT domain')
parser.add_argument('-gpus',  type=str, default="0", help='list of visiable GPUs')
parser.add_argument('-expName', type=str, default='U-Net', help='Experiment name')
...
parser.add_argument('-dsfn',  type=str, default='Dataset/train-dataset-processedby-ViT.h5', help='h5 dataset file')
...
itr_out_dir = 'Output/train-dataset-processedby-ViT-L1'
